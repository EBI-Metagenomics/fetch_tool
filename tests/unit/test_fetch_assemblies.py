...
class TestFetchAssemblies:
    ...
    def mock_get_study_from_assembly(self, *args, **kwargs):
        return [
            {
                "analysis_accession": "ERZ1505406",
                "secondary_study_accession": "ERP123564",
            }
        ]
    ...
    def mock_get_assembly_metadata(self, *args, **kwargs):
        return [
            {
                "analysis_accession": "ERZ1505403",
                "study_accession": "PRJEB39980",
                "analysis_type": "SEQUENCE_ASSEMBLY",
                "center_name": "EMG",
                "first_public": "2020-08-22",
